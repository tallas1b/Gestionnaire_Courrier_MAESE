...
public class Generer_registre_depart_secret extends Service<Boolean>{
		...
		public Generer_registre_depart_secret(List<Beans_Message_Depart> list , File file) {
		...
		public boolean create_file(File f) {
			...
			try {
				...
				//add model concerne
				Paragraph para_model = creat_paragraphe_model_concerne("MESSAGE DEPART SECRET");
