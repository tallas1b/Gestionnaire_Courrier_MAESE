...
public class Generer_registre_arrive_secret extends Service<Boolean>{
		...
		public Generer_registre_arrive_secret(List<Beans_Message_Arrive> list , File file) {
		...
		public boolean create_file(File f) {
			...
			try {
				...
				//add model concerne
				Paragraph para_model = creat_paragraphe_model_concerne("MESSAGE ARRIVE SECRET");
