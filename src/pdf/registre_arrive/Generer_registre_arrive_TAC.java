...
public class Generer_registre_arrive_TAC extends Service<Boolean>{
		...
		public Generer_registre_arrive_TAC(List<Beans_Message_Arrive> list , File file) {
		...
		public boolean create_file(File f) {
			...
			try {
				...
				//add model concerne
				Paragraph para_model = creat_paragraphe_model_concerne("MESSAGE ARRIVE TAC");
		...
		private Table creat_table(List<Beans_Message_Arrive> list) {
			try {
				...
				float [] pointColumnWidths = {70F,70F ,600F};
